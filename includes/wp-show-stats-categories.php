...
<div class="wrap">
  ...
  $id = $idObj->term_id;
		 wp_list_categories('orderby=name&show_count=1&include=' . $id); 
		 ?>
        </ul>
      </div>
    </div>
...
<script type="text/javascript">
            ...
            function drawChart() {
                ...
                // chart for least used categories
                <?php if($totalCategory > 0): ?>
                    ...
                    var lessusedoptions = {
                        width: 1015,
                        height: 500,
                        title: "5 Least Used Categories (Total: <?php echo $totalCategory; ?>)",
                        bar: {groupWidth: "70%"},
                        legend: {position: "none"},
                    };
                ...
                <?php else: ?>
                    document.getElementById('lessUsedChart').innerHTML = "<span class='nothingtodo'>There is nothing to show here for 'Least Used Category Stats' because there are no categories found.</span>";
                <?php endif; ?> 
